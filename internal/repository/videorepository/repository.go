...
func (r *VideoRepository) GetByID(ctx context.Context, id uuid.UUID) (*video.Video, error) {
	const sql = `
...
func (r *VideoRepository) UpdateStatus(ctx context.Context, v *video.Video) error {
	const sql = `
		UPDATE videos 
